  ...
  return (
    <section class="footer-container">
      <div class="joinUs-main">
        ...
        <form action="" class="joinUs-submit-form">
          <div class="joinUs-inputBox">
            <input type="email" placeholder=" " required />
            <span class="joinUs-icon">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
                <polyline points="22,6 12,13 2,6"></polyline>
              </svg>
            </span>
            <span class="joinUs-email">email</span>
          </div>
        </form>
        <div class="followUs-content">
          <h1>Stay connected and never miss an update, follow us on our social media channels.</h1>
          <ul class="followUs-socials">
            <li class="followUs-socials-link">
              <Link to="/">
